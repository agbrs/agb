...
_all-crates target:
    for CARGO_PROJECT_FILE in agb/Cargo.toml tracker/agb-tracker/Cargo.toml tracker/desktop-player/Cargo.toml embassy-agb/Cargo.toml embassy-agb-macros/Cargo.toml ./Cargo.toml; do \
